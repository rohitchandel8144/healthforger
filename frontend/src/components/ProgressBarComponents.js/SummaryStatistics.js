...
const SummaryStatistics = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 md:p-6 mt-4 md:mt-6 max-w-lg w-full mx-auto">
    <h2 className="text-lg md:text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100 border-b pb-2">
      Summary Statistics
    </h2>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
      <div className="bg-blue-50 dark:bg-blue-900 rounded-lg p-4 shadow-sm">
        <h3 className="text-base md:text-lg font-medium text-blue-700 dark:text-blue-300">
          Weekly Summary
        </h3>
      ...
      <div className="bg-green-50 dark:bg-green-900 rounded-lg p-4 shadow-sm">
        <h3 className="text-base md:text-lg font-medium text-green-700 dark:text-green-300">
          Monthly Summary
        </h3>
        <p className="text-gray-700 dark:text-gray-300 mt-2">
          Total Completed:{" "}
      ...
      <div className="bg-purple-50 dark:bg-purple-900 rounded-lg p-4 shadow-sm md:col-span-2">
        <h3 className="text-base md:text-lg font-medium text-purple-700 dark:text-purple-300">
          Milestones
        </h3>
        <p className="text-gray-700 dark:text-gray-300 mt-2">
