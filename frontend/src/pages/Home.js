  ...
  return (
    ...
    <div className="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 min-h-screen relative">
      ...
      <div className="relative h-[400px] md:h-[600px] overflow-hidden">
        <ImageSlider />
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-center z-10">
          {/* Hero Section */}
          <motion.h1
          ...
          <div className="flex space-x-4">
            {auth ? (
              <div className="text-white text-center p-4  rounded-md shadow-lg">
                <motion.h2
              ...
              <>
                ...
                >
                  <Link to="/login">
                    <motion.button className="bg-blue-500 text-white px-6 py-3 rounded-md hover:bg-blue-600">
                      Login
                    </motion.button>
                  </Link>
                </motion.div>
      ...
      <div className="relative z-20 -mt-20 bg-gradient-to-r from-gray-200 to-gray-400 dark:from-gray-800 dark:to-gray-900">
        ...
        <section className="bg-sky-500 dark:bg-blue-700 text-white py-16 px-4 text-center">
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Link to="/goalsetting">
              <motion.button className="bg-green-500 text-white px-6 py-3 rounded-md hover:bg-green-700">
                Get Started
              </motion.button>
            </Link>
          </motion.div>
